...
public class RuntimeServiceTest {
    ...
    public void startProcessByInitiator(){
        ...
        //启动流程
        ProcessInstance processInstance = runtimeService.startProcessInstanceByKey("leave03");
    ...
    public void activateOrsuspend(){
        ...
        // 激活
        if (state == 1) {
            runtimeService.activateProcessInstanceById("68325d0f-ca0d-11ed-a2b4-004238a4ec73");
        }
        // 挂起
        if (state == 2) {
